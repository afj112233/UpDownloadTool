...
{
    public class CIPUDTypeStub : CipBaseObject 
    {
        public CIPUDTypeStub(int instanceId, ICipMessager messager) :
            base(184, instanceId, messager)
        {
        }
        ...
        public async Task Remove(Int32 param0)
        {
            List<byte> param = new List<byte>();
            param.AddRange(BitConverter.GetBytes(param0));
