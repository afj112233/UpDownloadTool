...
namespace OxyPlot.Wpf
{
    ...
    public partial class PlotBase
    {
        ...
        protected override void OnMouseWheel(MouseWheelEventArgs e)
        {
            ...
            zoomOptions.Push(args);
            e.Handled = this.ActualController.HandleMouseWheel(this, args);
        }

        public readonly Stack<OxyMouseWheelEventArgs> zoomOptions=new Stack<OxyMouseWheelEventArgs>();
