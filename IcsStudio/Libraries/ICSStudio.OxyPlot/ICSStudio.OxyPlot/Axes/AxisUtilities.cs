...
namespace OxyPlot.Axes
{
    ...
    public static class AxisUtilities
    {
        ...
        /// <param name="needRound"></param>
        /// <returns>A sequence of values.</returns>
        /// <exception cref="System.ArgumentException">Step cannot be zero or negative.;step</exception>
        public static IList<double> CreateTickValues(double from, double to, double step, int maxTicks = 1000,bool needRound=true)
        {
            if (step <= 0)
            {
            ...
            var startValue = needRound?Math.Round(from / step) * step:from;
