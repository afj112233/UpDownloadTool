...
namespace OxyPlot.Series
{
    ...
    public abstract class XYAxisSeries : ItemsSeries
    {
        ...
        public Axis YAxis
        {
            get
            {
                if (PlotModel?.ScaleOption == ScaleOption.Independent&&!PlotModel.InIsolated && LeftAxes != null)
                    return LeftAxes;
                return _yAxis;
            }
        ...
        /// <summary>
        /// for displaying series independently 
        /// </summary>
        public LinearAxis LeftAxes { protected set; get; }
