...
{
    public class Int32ValidationRule : IntegerValidationRule
    {
        public override ValidationResult Validate(object value, CultureInfo cultureInfo)
        {
            ...
            try
            {
                if (input.StartsWith("2#"))
                {
                    ...
                    var unused = Convert.ToInt32(input, 2);
                }
                else if (input.StartsWith("8#"))
                {
                    ...
                    var unused = Convert.ToInt32(input, 8);
                }
                else if (input.StartsWith("16#"))
                {
                    ...
                    var unused = Convert.ToInt32(input, 16);
                }

                else if (Wrapper.DisplayStyle == DisplayStyle.Binary)
                {
                    var unusedBinary = Convert.ToInt32(input, 2);
                }

                else if (Wrapper.DisplayStyle == DisplayStyle.Octal)
                {
                    var unusedOctal = Convert.ToInt32(input, 8);
                }

                else if (Wrapper.DisplayStyle == DisplayStyle.Hex)
                {
                    var unusedHex = Convert.ToInt32(input, 16);
                }

                else
                {
                    var unused = int.Parse(input);
                }
            }
            catch (Exception)
            {
