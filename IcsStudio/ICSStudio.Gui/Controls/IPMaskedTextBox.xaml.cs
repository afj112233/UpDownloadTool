...
{
    /// <summary>
    /// IPMaskedTextBox.xaml 的交互逻辑
    /// </summary>
    public partial class IPMaskedTextBox :  INotifyPropertyChanged
    {
        ...
        private static void IPPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                _updateIP = false;
                ((IPMaskedTextBox) (d)).First = "";
                ((IPMaskedTextBox) (d)).Second = "";
                ((IPMaskedTextBox) (d)).Third = "";
                ((IPMaskedTextBox) (d)).Fourth = "";
                _updateIP = true;
            }
        ...
        private void jumpRight(TextBox currentBox, TextBox rightNeighborBox, KeyEventArgs e)
        {
            if (currentBox.Text != string.Empty)
            {
        ...
        private bool checkJumpRight(TextBox currentBox, TextBox rightNeighborBox, KeyEventArgs e)
        {
            switch (e.Key)
            {
                case Key.Right:
                    ...
                    {
                        jumpRight(currentBox,rightNeighborBox, e);
                    }
