...
namespace ICSStudio.DeviceProperties.DiscreteIOs.Panel
{
    ...
    public class ModuleInfoViewModel : DeviceOptionPanel
    {
        ...
        public ModuleInfoViewModel(UserControl panel, ModifiedDiscreteIO modifiedDiscreteIO) : base(panel)
        {
        ...
        public string ModuleIdentity
        {
            get
            {
                if (_descriptor != null)
                {
                    int vendor = ModifiedDiscreteIO.OriginalDiscreteIO.Vendor;
                    int productCode = ModifiedDiscreteIO.OriginalDiscreteIO.ProductCode;
                    int productType = ModifiedDiscreteIO.OriginalDiscreteIO.ProductType;
                    int majorRevision = ModifiedDiscreteIO.OriginalDiscreteIO.Major;
            ...
            if (result == MessageBoxResult.Yes)
            {
                ThreadHelper.JoinableTaskFactory.RunAsync(async delegate
                {
                    ...
                    ResettingDialog dialog = new ResettingDialog
                    {
                        ...
                        DataContext = new IOModuleResetting(ModifiedDiscreteIO.OriginalDiscreteIO)
                    };
        ...
        private void ExecuteRefreshCommand()
        {
            ThreadHelper.JoinableTaskFactory.RunAsync(async delegate
            {
                ...
                var viewModel = new IOModuleRefreshing(ModifiedDiscreteIO.OriginalDiscreteIO);
