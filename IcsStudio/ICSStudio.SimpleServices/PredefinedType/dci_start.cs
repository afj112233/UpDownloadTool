...
{
    public sealed class DCI_START : NativeType
    {
        private DCI_START()
        {
            Name = "DCI_START";
        ...
        public static readonly DCI_START Inst = new DCI_START();
        public override IField Create(JToken token)
        {
            var res = new DCI_STARTField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class DCI_STARTField : PreDefinedField
    {
        public DCI_STARTField(JToken token)
        {
            ...
            fields.Add(Tuple.Create(new Int32Field(array?[8]) as IField, 16));
            fields.Add(Tuple.Create(new Int8Field(array?[9]) as IField, 20));
            fields.Add(Tuple.Create(new Int8Field(array?[10]) as IField, 21));
            fields.Add(Tuple.Create(new Int8Field(array?[11]) as IField, 22));
