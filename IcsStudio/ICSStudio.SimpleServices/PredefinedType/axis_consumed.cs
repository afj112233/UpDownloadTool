...
{
    public sealed class AXIS_CONSUMED : NativeType
    {
        private AXIS_CONSUMED()
        {
            Name = "AXIS_CONSUMED";
            {
        ...
        public static readonly AXIS_CONSUMED Inst = new AXIS_CONSUMED();
        public override IField Create(JToken token)
        {
            var res = new AXIS_CONSUMEDField(token);
            FixUp(token, res);
            return res;
        }
        ...
        public override int BitSize => 1024;
        public override int ByteSize => 128;
        public const int size = 128;
    }
    public sealed class AXIS_CONSUMEDField : PreDefinedField
    {
        public AXIS_CONSUMEDField(JToken token)
        {
