...
{
    public sealed class LIGHT_CURTAIN : NativeType
    {
        private LIGHT_CURTAIN()
        {
            Name = "LIGHT_CURTAIN";
            {
        ...
        public static readonly LIGHT_CURTAIN Inst = new LIGHT_CURTAIN();
        public override IField Create(JToken token)
        {
            var res = new LIGHT_CURTAINField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class LIGHT_CURTAINField : PreDefinedField
    {
        public LIGHT_CURTAINField(JToken token)
        {
            ...
            fields.Add(Tuple.Create(new Int32Field(array?[7]) as IField, 8));
            fields.Add(Tuple.Create(new Int8Field(array?[8]) as IField, 12));
            fields.Add(Tuple.Create(new Int8Field(array?[9]) as IField, 13));
            fields.Add(Tuple.Create(new Int8Field(array?[10]) as IField, 14));
            fields.Add(Tuple.Create(new Int8Field(array?[11]) as IField, 15));
            fields.Add(Tuple.Create(new Int8Field(array?[12]) as IField, 16));
            fields.Add(Tuple.Create(new Int8Field(array?[13]) as IField, 17));
            fields.Add(Tuple.Create(new Int8Field(array?[14]) as IField, 18));
            fields.Add(Tuple.Create(new Int8Field(array?[15]) as IField, 19));
        }
    }
}