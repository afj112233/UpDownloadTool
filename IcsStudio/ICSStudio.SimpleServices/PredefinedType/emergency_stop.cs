...
{
    public sealed class EMERGENCY_STOP : NativeType
    {
        private EMERGENCY_STOP()
        {
            Name = "EMERGENCY_STOP";
            {
        ...
        public static readonly EMERGENCY_STOP Inst = new EMERGENCY_STOP();
        public override IField Create(JToken token)
        {
            var res = new EMERGENCY_STOPField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class EMERGENCY_STOPField : PreDefinedField
    {
        public EMERGENCY_STOPField(JToken token)
        {
