...
{
    public sealed class COUNTER : NativeType
    {
        private COUNTER()
        {
            Name = "COUNTER";
        ...
        public static readonly COUNTER Inst = new COUNTER();
        public override IField Create(JToken token)
        {
            var res = new COUNTERField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class COUNTERField : PreDefinedField
    {
        public COUNTERField(JToken token)
        {
