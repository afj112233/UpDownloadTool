...
{
    public sealed class MUTING_TWO_SENSOR_SYM : NativeType
    {
        private MUTING_TWO_SENSOR_SYM()
        {
            Name = "MUTING_TWO_SENSOR_SYM";
            {
        ...
        public static readonly MUTING_TWO_SENSOR_SYM Inst = new MUTING_TWO_SENSOR_SYM();
        public override IField Create(JToken token)
        {
            var res = new MUTING_TWO_SENSOR_SYMField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class MUTING_TWO_SENSOR_SYMField : PreDefinedField
    {
        public MUTING_TWO_SENSOR_SYMField(JToken token)
        {
