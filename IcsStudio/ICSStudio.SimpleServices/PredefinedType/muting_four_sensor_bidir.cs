...
{
    public sealed class MUTING_FOUR_SENSOR_BIDIR : NativeType
    {
        private MUTING_FOUR_SENSOR_BIDIR()
        {
            Name = "MUTING_FOUR_SENSOR_BIDIR";
            {
        ...
        public static readonly MUTING_FOUR_SENSOR_BIDIR Inst = new MUTING_FOUR_SENSOR_BIDIR();
        public override IField Create(JToken token)
        {
            var res = new MUTING_FOUR_SENSOR_BIDIRField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class MUTING_FOUR_SENSOR_BIDIRField : PreDefinedField
    {
        public MUTING_FOUR_SENSOR_BIDIRField(JToken token)
        {
            ...
            fields.Add(Tuple.Create(new Int32Field(array?[18]) as IField, 36));
            fields.Add(Tuple.Create(new Int8Field(array?[19]) as IField, 40));
            fields.Add(Tuple.Create(new Int8Field(array?[20]) as IField, 41));
            fields.Add(Tuple.Create(new Int8Field(array?[21]) as IField, 42));
            fields.Add(Tuple.Create(new Int8Field(array?[22]) as IField, 43));
            fields.Add(Tuple.Create(new Int8Field(array?[23]) as IField, 44));
            fields.Add(Tuple.Create(new Int32Field(array?[24]) as IField, 48));
            fields.Add(Tuple.Create(new Int32Field(array?[25]) as IField, 52));
        }
    }
}