...
{
    public sealed class SFC_STEP : NativeType
    {
        private SFC_STEP()
        {
            Name = "SFC_STEP";
        ...
        public static readonly SFC_STEP Inst = new SFC_STEP();
        public override IField Create(JToken token)
        {
            var res = new SFC_STEPField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class SFC_STEPField : PreDefinedField
    {
        public SFC_STEPField(JToken token)
        {
