...
{
    public sealed class DATALOG_INSTRUCTION : NativeType
    {
        private DATALOG_INSTRUCTION()
        {
            Name = "DATALOG_INSTRUCTION";
            {
        ...
        public static readonly DATALOG_INSTRUCTION Inst = new DATALOG_INSTRUCTION();
        public override IField Create(JToken token)
        {
            var res = new DATALOG_INSTRUCTIONField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class DATALOG_INSTRUCTIONField : PreDefinedField
    {
        public DATALOG_INSTRUCTIONField(JToken token)
        {
