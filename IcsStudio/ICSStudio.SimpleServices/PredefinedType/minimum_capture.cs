...
{
    public sealed class MINIMUM_CAPTURE : NativeType
    {
        private MINIMUM_CAPTURE()
        {
            Name = "MINIMUM_CAPTURE";
            {
        ...
        public static readonly MINIMUM_CAPTURE Inst = new MINIMUM_CAPTURE();
        public override IField Create(JToken token)
        {
            var res = new MINIMUM_CAPTUREField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class MINIMUM_CAPTUREField : PreDefinedField
    {
        public MINIMUM_CAPTUREField(JToken token)
        {
