...
{
    public sealed class OUTPUT_CAM : NativeType
    {
        private OUTPUT_CAM()
        {
            Name = "OUTPUT_CAM";
        ...
        public static readonly OUTPUT_CAM Inst = new OUTPUT_CAM();
        public override IField Create(JToken token)
        {
            var res = new OUTPUT_CAMField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class OUTPUT_CAMField : PreDefinedField
    {
        public OUTPUT_CAMField(JToken token)
        {
