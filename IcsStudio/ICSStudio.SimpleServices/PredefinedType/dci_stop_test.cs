...
{
    public sealed class DCI_STOP_TEST : NativeType
    {
        private DCI_STOP_TEST()
        {
            Name = "DCI_STOP_TEST";
            {
        ...
        public static readonly DCI_STOP_TEST Inst = new DCI_STOP_TEST();
        public override IField Create(JToken token)
        {
            var res = new DCI_STOP_TESTField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class DCI_STOP_TESTField : PreDefinedField
    {
        public DCI_STOP_TESTField(JToken token)
        {
            ...
            fields.Add(Tuple.Create(new Int32Field(array?[9]) as IField, 12));
            fields.Add(Tuple.Create(new Int32Field(array?[10]) as IField, 16));
            fields.Add(Tuple.Create(new Int8Field(array?[11]) as IField, 20));
            fields.Add(Tuple.Create(new Int8Field(array?[12]) as IField, 21));
            fields.Add(Tuple.Create(new Int8Field(array?[13]) as IField, 22));
            fields.Add(Tuple.Create(new Int8Field(array?[14]) as IField, 23));
