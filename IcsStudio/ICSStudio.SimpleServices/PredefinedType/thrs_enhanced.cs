...
{
    public sealed class THRS_ENHANCED : NativeType
    {
        private THRS_ENHANCED()
        {
            Name = "THRS_ENHANCED";
            {
        ...
        public static readonly THRS_ENHANCED Inst = new THRS_ENHANCED();
        public override IField Create(JToken token)
        {
            var res = new THRS_ENHANCEDField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class THRS_ENHANCEDField : PreDefinedField
    {
        public THRS_ENHANCEDField(JToken token)
        {
