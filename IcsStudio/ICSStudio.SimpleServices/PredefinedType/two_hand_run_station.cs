...
{
    public sealed class TWO_HAND_RUN_STATION : NativeType
    {
        private TWO_HAND_RUN_STATION()
        {
            Name = "TWO_HAND_RUN_STATION";
            {
            ...
            }
            {
                var member = new DataTypeMember
                {
                    Name = "RightButtonNormallyClosed",
                    DisplayStyle = DisplayStyle.Decimal,
                    ExternalAccess = ExternalAccess.ReadWrite,
                    ByteOffset = 4,
                    BitOffset = 0,
        ...
        public static readonly TWO_HAND_RUN_STATION Inst = new TWO_HAND_RUN_STATION();
        public override IField Create(JToken token)
        {
            var res = new TWO_HAND_RUN_STATIONField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class TWO_HAND_RUN_STATIONField : PreDefinedField
    {
        public TWO_HAND_RUN_STATIONField(JToken token)
        {
