...
{
    public sealed class CONFIGURABLE_ROUT : NativeType
    {
        private CONFIGURABLE_ROUT()
        {
            Name = "CONFIGURABLE_ROUT";
            {
        ...
        public static readonly CONFIGURABLE_ROUT Inst = new CONFIGURABLE_ROUT();
        public override IField Create(JToken token)
        {
            var res = new CONFIGURABLE_ROUTField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class CONFIGURABLE_ROUTField : PreDefinedField
    {
        public CONFIGURABLE_ROUTField(JToken token)
        {
