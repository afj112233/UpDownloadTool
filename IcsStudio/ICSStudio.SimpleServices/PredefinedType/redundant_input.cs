...
{
    public sealed class REDUNDANT_INPUT : NativeType
    {
        private REDUNDANT_INPUT()
        {
            Name = "REDUNDANT_INPUT";
            {
        ...
        public static readonly REDUNDANT_INPUT Inst = new REDUNDANT_INPUT();
        public override IField Create(JToken token)
        {
            var res = new REDUNDANT_INPUTField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class REDUNDANT_INPUTField : PreDefinedField
    {
        public REDUNDANT_INPUTField(JToken token)
        {
