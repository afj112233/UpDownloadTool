...
{
    public sealed class DEADTIME : NativeType
    {
        private DEADTIME()
        {
            Name = "DEADTIME";
        ...
        public static readonly DEADTIME Inst = new DEADTIME();
        public override IField Create(JToken token)
        {
            var res = new DEADTIMEField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class DEADTIMEField : PreDefinedField
    {
        public DEADTIMEField(JToken token)
        {
            ...
            fields.Add(Tuple.Create(new Int8Field(array?[14]) as IField, 56));
            fields.Add(Tuple.Create(new Int32Field(array?[15]) as IField, 60));
            fields.Add(Tuple.Create(new Int32Field(array?[16]) as IField, 64));
