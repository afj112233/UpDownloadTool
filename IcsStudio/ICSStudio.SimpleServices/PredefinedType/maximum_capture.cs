...
{
    public sealed class MAXIMUM_CAPTURE : NativeType
    {
        private MAXIMUM_CAPTURE()
        {
        ...
        public static readonly MAXIMUM_CAPTURE Inst = new MAXIMUM_CAPTURE();
        public override IField Create(JToken token)
        {
            var res = new MAXIMUM_CAPTUREField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class MAXIMUM_CAPTUREField : PreDefinedField
    {
        public MAXIMUM_CAPTUREField(JToken token)
        {
