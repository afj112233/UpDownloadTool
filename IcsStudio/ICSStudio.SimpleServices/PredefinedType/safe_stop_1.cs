...
{
    public sealed class SAFE_STOP_1 : NativeType
    {
        private SAFE_STOP_1()
        {
            Name = "SAFE_STOP_1";
        ...
        public static readonly SAFE_STOP_1 Inst = new SAFE_STOP_1();
        public override IField Create(JToken token)
        {
            var res = new SAFE_STOP_1Field(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class SAFE_STOP_1Field : PreDefinedField
    {
        public SAFE_STOP_1Field(JToken token)
        {
            ...
            fields.Add(Tuple.Create(new Int8Field(array?[15]) as IField, 28));
            fields.Add(Tuple.Create(new Int8Field(array?[16]) as IField, 29));
            fields.Add(Tuple.Create(new RealField(array?[17]) as IField, 32));
