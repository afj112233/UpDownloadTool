...
{
    public sealed class INTEGRATOR : NativeType
    {
        private INTEGRATOR()
        {
            Name = "INTEGRATOR";
        ...
        public static readonly INTEGRATOR Inst = new INTEGRATOR();
        public override IField Create(JToken token)
        {
            var res = new INTEGRATORField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class INTEGRATORField : PreDefinedField
    {
        public INTEGRATORField(JToken token)
        {
            ...
            fields.Add(Tuple.Create(new Int8Field(array?[8]) as IField, 29));
            fields.Add(Tuple.Create(new Int32Field(array?[9]) as IField, 32));
            fields.Add(Tuple.Create(new RealField(array?[10]) as IField, 36));
            fields.Add(Tuple.Create(new Int32Field(array?[11]) as IField, 40));
            fields.Add(Tuple.Create(new Int32Field(array?[12]) as IField, 44));
            fields.Add(Tuple.Create(new Int8Field(array?[13]) as IField, 48));
            fields.Add(Tuple.Create(new RealField(array?[14]) as IField, 52));
            fields.Add(Tuple.Create(new Int8Field(array?[15]) as IField, 56));
            fields.Add(Tuple.Create(new Int8Field(array?[16]) as IField, 57));
            fields.Add(Tuple.Create(new RealField(array?[17]) as IField, 60));
            fields.Add(Tuple.Create(new Int32Field(array?[18]) as IField, 64));
            fields.Add(Tuple.Create(new Int8Field(array?[19]) as IField, 68));
