...
{
    public sealed class FBD_MATH_ADVANCED : NativeType
    {
        private FBD_MATH_ADVANCED()
        {
            Name = "FBD_MATH_ADVANCED";
            {
        ...
        public static readonly FBD_MATH_ADVANCED Inst = new FBD_MATH_ADVANCED();
        public override IField Create(JToken token)
        {
            var res = new FBD_MATH_ADVANCEDField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class FBD_MATH_ADVANCEDField : PreDefinedField
    {
        public FBD_MATH_ADVANCEDField(JToken token)
        {
