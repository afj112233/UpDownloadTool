...
{
    public sealed class REDUNDANT_OUTPUT : NativeType
    {
        private REDUNDANT_OUTPUT()
        {
            Name = "REDUNDANT_OUTPUT";
            {
        ...
        public static readonly REDUNDANT_OUTPUT Inst = new REDUNDANT_OUTPUT();
        public override IField Create(JToken token)
        {
            var res = new REDUNDANT_OUTPUTField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class REDUNDANT_OUTPUTField : PreDefinedField
    {
        public REDUNDANT_OUTPUTField(JToken token)
        {
