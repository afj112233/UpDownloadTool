...
{
    public sealed class SAFELY_LIMITED_SPEED : NativeType
    {
        private SAFELY_LIMITED_SPEED()
        {
            Name = "SAFELY_LIMITED_SPEED";
            {
        ...
        public static readonly SAFELY_LIMITED_SPEED Inst = new SAFELY_LIMITED_SPEED();
        public override IField Create(JToken token)
        {
            var res = new SAFELY_LIMITED_SPEEDField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class SAFELY_LIMITED_SPEEDField : PreDefinedField
    {
        public SAFELY_LIMITED_SPEEDField(JToken token)
        {
