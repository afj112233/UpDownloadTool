...
{
    public sealed class FBD_COMPARE : NativeType
    {
        private FBD_COMPARE()
        {
            Name = "FBD_COMPARE";
        ...
        public static readonly FBD_COMPARE Inst = new FBD_COMPARE();
        public override IField Create(JToken token)
        {
            var res = new FBD_COMPAREField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class FBD_COMPAREField : PreDefinedField
    {
        public FBD_COMPAREField(JToken token)
        {
