...
{
    public sealed class FBD_LOGICAL : NativeType
    {
        private FBD_LOGICAL()
        {
            Name = "FBD_LOGICAL";
        ...
        public static readonly FBD_LOGICAL Inst = new FBD_LOGICAL();
        public override IField Create(JToken token)
        {
            var res = new FBD_LOGICALField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class FBD_LOGICALField : PreDefinedField
    {
        public FBD_LOGICALField(JToken token)
        {
