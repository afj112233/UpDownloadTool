...
{
    public sealed class FLIP_FLOP_D : NativeType
    {
        private FLIP_FLOP_D()
        {
            Name = "FLIP_FLOP_D";
        ...
        public static readonly FLIP_FLOP_D Inst = new FLIP_FLOP_D();
        public override IField Create(JToken token)
        {
            var res = new FLIP_FLOP_DField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class FLIP_FLOP_DField : PreDefinedField
    {
        public FLIP_FLOP_DField(JToken token)
        {
