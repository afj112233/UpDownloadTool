...
{
    public sealed class ALARM : NativeType
    {
        private ALARM()
        {
            Name = "ALARM";
        ...
        public static readonly ALARM Inst = new ALARM();
        public override IField Create(JToken token)
        {
            var res = new ALARMField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class ALARMField : PreDefinedField
    {
        public ALARMField(JToken token)
        {
            ...
            fields.Add(Tuple.Create(new RealField(array?[17]) as IField, 48));
            fields.Add(Tuple.Create(new Int32Field(array?[18]) as IField, 52));
            fields.Add(Tuple.Create(new RealField(array?[19]) as IField, 56));
            fields.Add(Tuple.Create(new RealField(array?[20]) as IField, 60));
        }
    }
}