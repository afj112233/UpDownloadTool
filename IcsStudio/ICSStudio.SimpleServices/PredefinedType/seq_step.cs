...
{
    public sealed class SEQ_STEP : NativeType
    {
        private SEQ_STEP()
        {
            Name = "SEQ_STEP";
        ...
        public static readonly SEQ_STEP Inst = new SEQ_STEP();
        public override IField Create(JToken token)
        {
            var res = new SEQ_STEPField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class SEQ_STEPField : PreDefinedField
    {
        public SEQ_STEPField(JToken token)
        {
            ...
            fields.Add(Tuple.Create(new Int8Field(array?[17]) as IField, 62));
            fields.Add(Tuple.Create(new Int8Field(array?[18]) as IField, 63));
            fields.Add(Tuple.Create(new Int8Field(array?[19]) as IField, 64));
            fields.Add(Tuple.Create(new Int8Field(array?[20]) as IField, 65));
            fields.Add(Tuple.Create(new Int8Field(array?[21]) as IField, 66));
            fields.Add(Tuple.Create(new Int8Field(array?[22]) as IField, 67));
            fields.Add(Tuple.Create(new Int8Field(array?[23]) as IField, 68));
            fields.Add(Tuple.Create(new Int8Field(array?[24]) as IField, 69));
        }
    }
}