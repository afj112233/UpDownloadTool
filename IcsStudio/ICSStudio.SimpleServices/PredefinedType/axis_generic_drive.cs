...
{
    public sealed class AXIS_GENERIC_DRIVE : NativeType
    {
        private AXIS_GENERIC_DRIVE()
        {
            Name = "AXIS_GENERIC_DRIVE";
            {
            ...
            }
            {
                var member = new DataTypeMember
                {
                    Name = "ManufacturerSpecificFault",
                    DisplayStyle = DisplayStyle.Decimal,
                    ExternalAccess = ExternalAccess.ReadWrite,
                    ByteOffset = 141,
                    BitOffset = 0,
        ...
        public static readonly AXIS_GENERIC_DRIVE Inst = new AXIS_GENERIC_DRIVE();
        public override IField Create(JToken token)
        {
            var res = new AXIS_GENERIC_DRIVEField(token);
            FixUp(token, res);
            return res;
        }
        ...
        public override int BitSize => 1152;
        public override int ByteSize => 144;
        public const int size = 144;
    }
    public sealed class AXIS_GENERIC_DRIVEField : PreDefinedField
    {
        public AXIS_GENERIC_DRIVEField(JToken token)
        {
            ...
            fields.Add(Tuple.Create(new Int8Field(array?[31]) as IField, 124));
            fields.Add(Tuple.Create(new Int16Field(array?[32]) as IField, 126));
            fields.Add(Tuple.Create(new Int16Field(array?[33]) as IField, 128));
            fields.Add(Tuple.Create(new Int32Field(array?[34]) as IField, 132));
            fields.Add(Tuple.Create(new Int32Field(array?[35]) as IField, 136));
            fields.Add(Tuple.Create(new Int8Field(array?[36]) as IField, 140));
            fields.Add(Tuple.Create(new Int8Field(array?[37]) as IField, 141));
            fields.Add(Tuple.Create(new Int16Field(array?[38]) as IField, 142));
        }
    }
}