...
{
    public sealed class MOVING_AVERAGE : NativeType
    {
        private MOVING_AVERAGE()
        {
            Name = "MOVING_AVERAGE";
            {
        ...
        public static readonly MOVING_AVERAGE Inst = new MOVING_AVERAGE();
        public override IField Create(JToken token)
        {
            var res = new MOVING_AVERAGEField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class MOVING_AVERAGEField : PreDefinedField
    {
        public MOVING_AVERAGEField(JToken token)
        {
            ...
            fields.Add(Tuple.Create(new Int8Field(array?[10]) as IField, 28));
            fields.Add(Tuple.Create(new Int32Field(array?[11]) as IField, 32));
            fields.Add(Tuple.Create(new Int32Field(array?[12]) as IField, 36));
            fields.Add(Tuple.Create(new Int32Field(array?[13]) as IField, 40));
        }
    }
}