...
{
    public sealed class SAFE_DIRECTION : NativeType
    {
        private SAFE_DIRECTION()
        {
            Name = "SAFE_DIRECTION";
            {
        ...
        public static readonly SAFE_DIRECTION Inst = new SAFE_DIRECTION();
        public override IField Create(JToken token)
        {
            var res = new SAFE_DIRECTIONField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class SAFE_DIRECTIONField : PreDefinedField
    {
        public SAFE_DIRECTIONField(JToken token)
        {
