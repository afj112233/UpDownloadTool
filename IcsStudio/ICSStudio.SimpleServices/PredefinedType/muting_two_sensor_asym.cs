...
{
    public sealed class MUTING_TWO_SENSOR_ASYM : NativeType
    {
        private MUTING_TWO_SENSOR_ASYM()
        {
            Name = "MUTING_TWO_SENSOR_ASYM";
            {
        ...
        public static readonly MUTING_TWO_SENSOR_ASYM Inst = new MUTING_TWO_SENSOR_ASYM();
        public override IField Create(JToken token)
        {
            var res = new MUTING_TWO_SENSOR_ASYMField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class MUTING_TWO_SENSOR_ASYMField : PreDefinedField
    {
        public MUTING_TWO_SENSOR_ASYMField(JToken token)
        {
            ...
            fields.Add(Tuple.Create(new Int32Field(array?[12]) as IField, 12));
            ...
            fields.Add(Tuple.Create(new Int32Field(array?[17]) as IField, 32));
            fields.Add(Tuple.Create(new Int8Field(array?[18]) as IField, 36));
            fields.Add(Tuple.Create(new Int8Field(array?[19]) as IField, 37));
            fields.Add(Tuple.Create(new Int8Field(array?[20]) as IField, 38));
            fields.Add(Tuple.Create(new Int8Field(array?[21]) as IField, 39));
            fields.Add(Tuple.Create(new Int8Field(array?[22]) as IField, 40));
            fields.Add(Tuple.Create(new Int32Field(array?[23]) as IField, 44));
            fields.Add(Tuple.Create(new Int32Field(array?[24]) as IField, 48));
        }
    }
}