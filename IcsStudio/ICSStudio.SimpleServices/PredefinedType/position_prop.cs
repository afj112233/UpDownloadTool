...
{
    public sealed class POSITION_PROP : NativeType
    {
        private POSITION_PROP()
        {
            Name = "POSITION_PROP";
            {
        ...
        public static readonly POSITION_PROP Inst = new POSITION_PROP();
        public override IField Create(JToken token)
        {
            var res = new POSITION_PROPField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class POSITION_PROPField : PreDefinedField
    {
        public POSITION_PROPField(JToken token)
        {
            ...
            fields.Add(Tuple.Create(new Int8Field(array?[14]) as IField, 49));
            fields.Add(Tuple.Create(new Int8Field(array?[15]) as IField, 50));
            fields.Add(Tuple.Create(new RealField(array?[16]) as IField, 52));
            fields.Add(Tuple.Create(new RealField(array?[17]) as IField, 56));
            fields.Add(Tuple.Create(new RealField(array?[18]) as IField, 60));
            fields.Add(Tuple.Create(new RealField(array?[19]) as IField, 64));
            fields.Add(Tuple.Create(new Int32Field(array?[20]) as IField, 68));
            fields.Add(Tuple.Create(new Int8Field(array?[21]) as IField, 72));
        }
    }
}