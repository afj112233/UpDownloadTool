...
{
    public sealed class DCI_STOP : NativeType
    {
        private DCI_STOP()
        {
            Name = "DCI_STOP";
        ...
        public static readonly DCI_STOP Inst = new DCI_STOP();
        public override IField Create(JToken token)
        {
            var res = new DCI_STOPField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class DCI_STOPField : PreDefinedField
    {
        public DCI_STOPField(JToken token)
        {
            ...
            fields.Add(Tuple.Create(new Int32Field(array?[8]) as IField, 12));
            fields.Add(Tuple.Create(new Int32Field(array?[9]) as IField, 16));
            fields.Add(Tuple.Create(new Int8Field(array?[10]) as IField, 20));
            fields.Add(Tuple.Create(new Int8Field(array?[11]) as IField, 21));
            fields.Add(Tuple.Create(new Int8Field(array?[12]) as IField, 22));
