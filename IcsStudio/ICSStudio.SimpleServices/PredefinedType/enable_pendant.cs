...
{
    public sealed class ENABLE_PENDANT : NativeType
    {
        private ENABLE_PENDANT()
        {
            Name = "ENABLE_PENDANT";
            {
        ...
        public static readonly ENABLE_PENDANT Inst = new ENABLE_PENDANT();
        public override IField Create(JToken token)
        {
            var res = new ENABLE_PENDANTField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class ENABLE_PENDANTField : PreDefinedField
    {
        public ENABLE_PENDANTField(JToken token)
        {
