...
{
    public sealed class AXIS_SERVO : NativeType
    {
        private AXIS_SERVO()
        {
            Name = "AXIS_SERVO";
        ...
        public static readonly AXIS_SERVO Inst = new AXIS_SERVO();
        public override IField Create(JToken token)
        {
            var res = new AXIS_SERVOField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class AXIS_SERVOField : PreDefinedField
    {
        public AXIS_SERVOField(JToken token)
        {
            ...
            fields.Add(Tuple.Create(new Int32Field(array?[31]) as IField, 124));
            fields.Add(Tuple.Create(new Int32Field(array?[32]) as IField, 128));
            fields.Add(Tuple.Create(new Int16Field(array?[33]) as IField, 132));
            fields.Add(Tuple.Create(new Int16Field(array?[34]) as IField, 134));
