...
{
    public sealed class DISCRETE_2STATE : NativeType
    {
        private DISCRETE_2STATE()
        {
            Name = "DISCRETE_2STATE";
            {
        ...
        public static readonly DISCRETE_2STATE Inst = new DISCRETE_2STATE();
        public override IField Create(JToken token)
        {
            var res = new DISCRETE_2STATEField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class DISCRETE_2STATEField : PreDefinedField
    {
        public DISCRETE_2STATEField(JToken token)
        {
            ...
            fields.Add(Tuple.Create(new RealField(array?[9]) as IField, 12));
            ...
            fields.Add(Tuple.Create(new Int32Field(array?[37]) as IField, 44));
            fields.Add(Tuple.Create(new Int8Field(array?[38]) as IField, 48));
            fields.Add(Tuple.Create(new Int8Field(array?[39]) as IField, 49));
            fields.Add(Tuple.Create(new Int8Field(array?[40]) as IField, 50));
            fields.Add(Tuple.Create(new Int8Field(array?[41]) as IField, 51));
            fields.Add(Tuple.Create(new Int8Field(array?[42]) as IField, 52));
            fields.Add(Tuple.Create(new Int8Field(array?[43]) as IField, 53));
            fields.Add(Tuple.Create(new RealField(array?[44]) as IField, 56));
            fields.Add(Tuple.Create(new RealField(array?[45]) as IField, 60));
        }
    }
}