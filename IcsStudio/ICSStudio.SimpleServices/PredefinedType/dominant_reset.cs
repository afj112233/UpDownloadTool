...
{
    public sealed class DOMINANT_RESET : NativeType
    {
        private DOMINANT_RESET()
        {
            Name = "DOMINANT_RESET";
            {
        ...
        public static readonly DOMINANT_RESET Inst = new DOMINANT_RESET();
        public override IField Create(JToken token)
        {
            var res = new DOMINANT_RESETField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class DOMINANT_RESETField : PreDefinedField
    {
        public DOMINANT_RESETField(JToken token)
        {
