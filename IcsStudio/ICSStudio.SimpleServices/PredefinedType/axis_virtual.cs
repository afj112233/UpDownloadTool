...
{
    public sealed class AXIS_VIRTUAL : AXIS_COMMON
    {
        private AXIS_VIRTUAL()
        {
            Name = "AXIS_VIRTUAL";
            {
        ...
        public static new readonly AXIS_VIRTUAL Inst = new AXIS_VIRTUAL();
        public override IField Create(JToken token)
        {
            var res = new AXIS_VIRTUALField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class AXIS_VIRTUALField : PreDefinedField
    {
        public AXIS_VIRTUALField(JToken token)
        {
