...
{
    public sealed class AXIS_GENERIC : NativeType
    {
        private AXIS_GENERIC()
        {
            Name = "AXIS_GENERIC";
            {
        ...
        public static readonly AXIS_GENERIC Inst = new AXIS_GENERIC();
        public override IField Create(JToken token)
        {
            var res = new AXIS_GENERICField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class AXIS_GENERICField : PreDefinedField
    {
        public AXIS_GENERICField(JToken token)
        {
