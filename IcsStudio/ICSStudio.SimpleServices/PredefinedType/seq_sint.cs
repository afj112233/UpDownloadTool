...
{
    public sealed class SEQ_SINT : NativeType
    {
        private SEQ_SINT()
        {
            Name = "SEQ_SINT";
        ...
        public static readonly SEQ_SINT Inst = new SEQ_SINT();
        public override IField Create(JToken token)
        {
            var res = new SEQ_SINTField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class SEQ_SINTField : PreDefinedField
    {
        public SEQ_SINTField(JToken token)
        {
