...
{
    public sealed class DIVERSE_INPUT : NativeType
    {
        private DIVERSE_INPUT()
        {
            Name = "DIVERSE_INPUT";
            {
        ...
        public static readonly DIVERSE_INPUT Inst = new DIVERSE_INPUT();
        public override IField Create(JToken token)
        {
            var res = new DIVERSE_INPUTField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class DIVERSE_INPUTField : PreDefinedField
    {
        public DIVERSE_INPUTField(JToken token)
        {
