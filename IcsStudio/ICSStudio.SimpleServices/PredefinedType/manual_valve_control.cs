...
{
    public sealed class MANUAL_VALVE_CONTROL : NativeType
    {
        private MANUAL_VALVE_CONTROL()
        {
            Name = "MANUAL_VALVE_CONTROL";
            {
        ...
        public static readonly MANUAL_VALVE_CONTROL Inst = new MANUAL_VALVE_CONTROL();
        public override IField Create(JToken token)
        {
            var res = new MANUAL_VALVE_CONTROLField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class MANUAL_VALVE_CONTROLField : PreDefinedField
    {
        public MANUAL_VALVE_CONTROLField(JToken token)
        {
