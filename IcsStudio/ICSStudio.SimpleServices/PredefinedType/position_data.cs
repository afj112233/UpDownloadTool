...
{
    public sealed class POSITION_DATA : NativeType
    {
        private POSITION_DATA()
        {
            Name = "POSITION_DATA";
            {
        ...
        public static readonly POSITION_DATA Inst = new POSITION_DATA();
        public override IField Create(JToken token)
        {
            var res = new POSITION_DATAField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class POSITION_DATAField : PreDefinedField
    {
        public POSITION_DATAField(JToken token)
        {
