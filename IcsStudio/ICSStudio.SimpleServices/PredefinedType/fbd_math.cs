...
{
    public sealed class FBD_MATH : NativeType
    {
        private FBD_MATH()
        {
            Name = "FBD_MATH";
        ...
        public static readonly FBD_MATH Inst = new FBD_MATH();
        public override IField Create(JToken token)
        {
            var res = new FBD_MATHField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class FBD_MATHField : PreDefinedField
    {
        public FBD_MATHField(JToken token)
        {
