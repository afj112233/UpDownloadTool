...
{
    public sealed class FILTER_HIGH_PASS : NativeType
    {
        private FILTER_HIGH_PASS()
        {
        ...
        public static readonly FILTER_HIGH_PASS Inst = new FILTER_HIGH_PASS();
        public override IField Create(JToken token)
        {
            var res = new FILTER_HIGH_PASSField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class FILTER_HIGH_PASSField : PreDefinedField
    {
        public FILTER_HIGH_PASSField(JToken token)
        {
