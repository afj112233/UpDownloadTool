...
{
    public sealed class FBD_LIMIT : NativeType
    {
        private FBD_LIMIT()
        {
            Name = "FBD_LIMIT";
        ...
        public static readonly FBD_LIMIT Inst = new FBD_LIMIT();
        public override IField Create(JToken token)
        {
            var res = new FBD_LIMITField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class FBD_LIMITField : PreDefinedField
    {
        public FBD_LIMITField(JToken token)
        {
