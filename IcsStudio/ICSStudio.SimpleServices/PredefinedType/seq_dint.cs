...
{
    public sealed class SEQ_DINT : NativeType
    {
        private SEQ_DINT()
        {
            Name = "SEQ_DINT";
        ...
        public static readonly SEQ_DINT Inst = new SEQ_DINT();
        public override IField Create(JToken token)
        {
            var res = new SEQ_DINTField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class SEQ_DINTField : PreDefinedField
    {
        public SEQ_DINTField(JToken token)
        {
