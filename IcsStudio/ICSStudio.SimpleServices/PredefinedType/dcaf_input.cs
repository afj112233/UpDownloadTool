...
{
    public sealed class DCAF_INPUT : NativeType
    {
        private DCAF_INPUT()
        {
            Name = "DCAF_INPUT";
        ...
        public static readonly DCAF_INPUT Inst = new DCAF_INPUT();
        public override IField Create(JToken token)
        {
            var res = new DCAF_INPUTField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class DCAF_INPUTField : PreDefinedField
    {
        public DCAF_INPUTField(JToken token)
        {
            ...
            fields.Add(Tuple.Create(new RealField(array?[5]) as IField, 8));
            fields.Add(Tuple.Create(new RealField(array?[6]) as IField, 12));
            fields.Add(Tuple.Create(new RealField(array?[7]) as IField, 16));
            fields.Add(Tuple.Create(new RealField(array?[8]) as IField, 20));
            fields.Add(Tuple.Create(new RealField(array?[9]) as IField, 24));
