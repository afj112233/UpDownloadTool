...
{
    public sealed class UP_DOWN_ACCUM : NativeType
    {
        private UP_DOWN_ACCUM()
        {
            Name = "UP_DOWN_ACCUM";
            {
        ...
        public static readonly UP_DOWN_ACCUM Inst = new UP_DOWN_ACCUM();
        public override IField Create(JToken token)
        {
            var res = new UP_DOWN_ACCUMField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class UP_DOWN_ACCUMField : PreDefinedField
    {
        public UP_DOWN_ACCUMField(JToken token)
        {
            ...
            fields.Add(Tuple.Create(new RealField(array?[2]) as IField, 4));
            fields.Add(Tuple.Create(new RealField(array?[3]) as IField, 8));
            fields.Add(Tuple.Create(new RealField(array?[4]) as IField, 12));
            fields.Add(Tuple.Create(new Int8Field(array?[5]) as IField, 16));
            fields.Add(Tuple.Create(new Int8Field(array?[6]) as IField, 17));
            fields.Add(Tuple.Create(new RealField(array?[7]) as IField, 20));
            fields.Add(Tuple.Create(new Int8Field(array?[8]) as IField, 24));
        }
    }
}