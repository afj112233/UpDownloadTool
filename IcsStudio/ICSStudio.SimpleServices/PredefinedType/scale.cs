...
{
    public sealed class SCALE : NativeType
    {
        private SCALE()
        {
            Name = "SCALE";
        ...
        public static readonly SCALE Inst = new SCALE();
        public override IField Create(JToken token)
        {
            var res = new SCALEField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class SCALEField : PreDefinedField
    {
        public SCALEField(JToken token)
        {
            ...
            fields.Add(Tuple.Create(new Int8Field(array?[7]) as IField, 25));
            fields.Add(Tuple.Create(new RealField(array?[8]) as IField, 28));
            fields.Add(Tuple.Create(new Int8Field(array?[9]) as IField, 32));
            fields.Add(Tuple.Create(new Int8Field(array?[10]) as IField, 33));
