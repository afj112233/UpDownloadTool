...
{
    public sealed class CONNECTION_STATUS : NativeType
    {
        ...
        public static readonly CONNECTION_STATUS Inst = new CONNECTION_STATUS();
        public override IField Create(JToken token)
        {
            var res = new CONNECTION_STATUSField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class CONNECTION_STATUSField : PreDefinedField
    {
        public CONNECTION_STATUSField(JToken token)
        {
