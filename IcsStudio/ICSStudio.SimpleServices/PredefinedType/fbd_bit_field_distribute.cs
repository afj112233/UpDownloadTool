...
{
    public sealed class FBD_BIT_FIELD_DISTRIBUTE : NativeType
    {
        private FBD_BIT_FIELD_DISTRIBUTE()
        {
            Name = "FBD_BIT_FIELD_DISTRIBUTE";
            {
        ...
        public static readonly FBD_BIT_FIELD_DISTRIBUTE Inst = new FBD_BIT_FIELD_DISTRIBUTE();
        public override IField Create(JToken token)
        {
            var res = new FBD_BIT_FIELD_DISTRIBUTEField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class FBD_BIT_FIELD_DISTRIBUTEField : PreDefinedField
    {
        public FBD_BIT_FIELD_DISTRIBUTEField(JToken token)
        {
