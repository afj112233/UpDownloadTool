...
{
    public sealed class EXT_ROUTINE_PARAMETERS : NativeType
    {
        private EXT_ROUTINE_PARAMETERS()
        {
            Name = "EXT_ROUTINE_PARAMETERS";
            {
        ...
        public static readonly EXT_ROUTINE_PARAMETERS Inst = new EXT_ROUTINE_PARAMETERS();
        public override IField Create(JToken token)
        {
            var res = new EXT_ROUTINE_PARAMETERSField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class EXT_ROUTINE_PARAMETERSField : PreDefinedField
    {
        public EXT_ROUTINE_PARAMETERSField(JToken token)
        {
