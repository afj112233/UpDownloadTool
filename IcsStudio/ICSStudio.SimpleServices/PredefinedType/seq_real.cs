...
{
    public sealed class SEQ_REAL : NativeType
    {
        private SEQ_REAL()
        {
            Name = "SEQ_REAL";
        ...
        public static readonly SEQ_REAL Inst = new SEQ_REAL();
        public override IField Create(JToken token)
        {
            var res = new SEQ_REALField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class SEQ_REALField : PreDefinedField
    {
        public SEQ_REALField(JToken token)
        {
