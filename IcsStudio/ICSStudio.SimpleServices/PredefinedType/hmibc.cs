...
{
    public sealed class HMIBC : NativeType
    {
        private HMIBC()
        {
            Name = "HMIBC";
        ...
        public static readonly HMIBC Inst = new HMIBC();
        public override IField Create(JToken token)
        {
            var res = new HMIBCField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class HMIBCField : PreDefinedField
    {
        public HMIBCField(JToken token)
        {
