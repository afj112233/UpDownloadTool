...
{
    public sealed class SAFE_BRAKE_CONTROL : NativeType
    {
        private SAFE_BRAKE_CONTROL()
        {
            Name = "SAFE_BRAKE_CONTROL";
            {
        ...
        public static readonly SAFE_BRAKE_CONTROL Inst = new SAFE_BRAKE_CONTROL();
        public override IField Create(JToken token)
        {
            var res = new SAFE_BRAKE_CONTROLField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class SAFE_BRAKE_CONTROLField : PreDefinedField
    {
        public SAFE_BRAKE_CONTROLField(JToken token)
        {
            ...
            fields.Add(Tuple.Create(new Int16Field(array?[17]) as IField, 18));
            fields.Add(Tuple.Create(new Int16Field(array?[18]) as IField, 20));
            fields.Add(Tuple.Create(new Int8Field(array?[19]) as IField, 22));
            fields.Add(Tuple.Create(new Int8Field(array?[20]) as IField, 23));
        }
    }
}