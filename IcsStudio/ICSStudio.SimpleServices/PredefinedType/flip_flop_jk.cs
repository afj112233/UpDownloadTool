...
{
    public sealed class FLIP_FLOP_JK : NativeType
    {
        private FLIP_FLOP_JK()
        {
            Name = "FLIP_FLOP_JK";
            {
        ...
        public static readonly FLIP_FLOP_JK Inst = new FLIP_FLOP_JK();
        public override IField Create(JToken token)
        {
            var res = new FLIP_FLOP_JKField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class FLIP_FLOP_JKField : PreDefinedField
    {
        public FLIP_FLOP_JKField(JToken token)
        {
