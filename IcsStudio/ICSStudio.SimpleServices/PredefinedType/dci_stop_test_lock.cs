...
{
    public sealed class DCI_STOP_TEST_LOCK : NativeType
    {
        private DCI_STOP_TEST_LOCK()
        {
        ...
        public static readonly DCI_STOP_TEST_LOCK Inst = new DCI_STOP_TEST_LOCK();
        public override IField Create(JToken token)
        {
            var res = new DCI_STOP_TEST_LOCKField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class DCI_STOP_TEST_LOCKField : PreDefinedField
    {
        public DCI_STOP_TEST_LOCKField(JToken token)
        {
            ...
            fields.Add(Tuple.Create(new Int32Field(array?[11]) as IField, 12));
            fields.Add(Tuple.Create(new Int32Field(array?[12]) as IField, 16));
            fields.Add(Tuple.Create(new Int32Field(array?[13]) as IField, 20));
            fields.Add(Tuple.Create(new Int8Field(array?[14]) as IField, 24));
            fields.Add(Tuple.Create(new Int8Field(array?[15]) as IField, 25));
            fields.Add(Tuple.Create(new Int8Field(array?[16]) as IField, 26));
            fields.Add(Tuple.Create(new Int8Field(array?[17]) as IField, 27));
            fields.Add(Tuple.Create(new Int8Field(array?[18]) as IField, 28));
            fields.Add(Tuple.Create(new Int32Field(array?[19]) as IField, 32));
            fields.Add(Tuple.Create(new Int32Field(array?[20]) as IField, 36));
        }
    }
}