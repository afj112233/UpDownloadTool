...
{
    public sealed class FBD_TRUNCATE : NativeType
    {
        private FBD_TRUNCATE()
        {
            Name = "FBD_TRUNCATE";
            {
        ...
        public static readonly FBD_TRUNCATE Inst = new FBD_TRUNCATE();
        public override IField Create(JToken token)
        {
            var res = new FBD_TRUNCATEField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class FBD_TRUNCATEField : PreDefinedField
    {
        public FBD_TRUNCATEField(JToken token)
        {
