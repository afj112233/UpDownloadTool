...
{
    public sealed class CB_CONTINUOUS_MODE : NativeType
    {
        private CB_CONTINUOUS_MODE()
        {
            Name = "CB_CONTINUOUS_MODE";
            {
        ...
        public static readonly CB_CONTINUOUS_MODE Inst = new CB_CONTINUOUS_MODE();
        public override IField Create(JToken token)
        {
            var res = new CB_CONTINUOUS_MODEField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class CB_CONTINUOUS_MODEField : PreDefinedField
    {
        public CB_CONTINUOUS_MODEField(JToken token)
        {
            ...
            fields.Add(Tuple.Create(new Int32Field(array?[17]) as IField, 24));
        }
    }
}