...
{
    public sealed class SPLIT_RANGE : NativeType
    {
        private SPLIT_RANGE()
        {
            Name = "SPLIT_RANGE";
        ...
        public static readonly SPLIT_RANGE Inst = new SPLIT_RANGE();
        public override IField Create(JToken token)
        {
            var res = new SPLIT_RANGEField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class SPLIT_RANGEField : PreDefinedField
    {
        public SPLIT_RANGEField(JToken token)
        {
            ...
            fields.Add(Tuple.Create(new Int8Field(array?[12]) as IField, 45));
            fields.Add(Tuple.Create(new Int8Field(array?[13]) as IField, 46));
            fields.Add(Tuple.Create(new RealField(array?[14]) as IField, 48));
            fields.Add(Tuple.Create(new RealField(array?[15]) as IField, 52));
            fields.Add(Tuple.Create(new Int32Field(array?[16]) as IField, 56));
            fields.Add(Tuple.Create(new Int8Field(array?[17]) as IField, 60));
        }
    }
}