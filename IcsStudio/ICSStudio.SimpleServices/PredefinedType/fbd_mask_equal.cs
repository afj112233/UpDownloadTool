...
{
    public sealed class FBD_MASK_EQUAL : NativeType
    {
        private FBD_MASK_EQUAL()
        {
            Name = "FBD_MASK_EQUAL";
            {
        ...
        public static readonly FBD_MASK_EQUAL Inst = new FBD_MASK_EQUAL();
        public override IField Create(JToken token)
        {
            var res = new FBD_MASK_EQUALField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class FBD_MASK_EQUALField : PreDefinedField
    {
        public FBD_MASK_EQUALField(JToken token)
        {
