...
{
    public sealed class SFC_STOP : NativeType
    {
        private SFC_STOP()
        {
            Name = "SFC_STOP";
        ...
        public static readonly SFC_STOP Inst = new SFC_STOP();
        public override IField Create(JToken token)
        {
            var res = new SFC_STOPField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class SFC_STOPField : PreDefinedField
    {
        public SFC_STOPField(JToken token)
        {
