...
{
    public sealed class RATE_LIMITER : NativeType
    {
        ...
        public static readonly RATE_LIMITER Inst = new RATE_LIMITER();
        public override IField Create(JToken token)
        {
            var res = new RATE_LIMITERField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class RATE_LIMITERField : PreDefinedField
    {
        public RATE_LIMITERField(JToken token)
        {
