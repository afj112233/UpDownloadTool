...
{
    public sealed class CAMSHAFT_MONITOR : NativeType
    {
        private CAMSHAFT_MONITOR()
        {
            Name = "CAMSHAFT_MONITOR";
            {
        ...
        public static readonly CAMSHAFT_MONITOR Inst = new CAMSHAFT_MONITOR();
        public override IField Create(JToken token)
        {
            var res = new CAMSHAFT_MONITORField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class CAMSHAFT_MONITORField : PreDefinedField
    {
        public CAMSHAFT_MONITORField(JToken token)
        {
            ...
            fields.Add(Tuple.Create(new Int32Field(array?[7]) as IField, 12));
            fields.Add(Tuple.Create(new Int8Field(array?[8]) as IField, 16));
            fields.Add(Tuple.Create(new Int8Field(array?[9]) as IField, 17));
            fields.Add(Tuple.Create(new Int8Field(array?[10]) as IField, 18));
            ...
            fields.Add(Tuple.Create(new Int32Field(array?[14]) as IField, 32));
        }
    }
}