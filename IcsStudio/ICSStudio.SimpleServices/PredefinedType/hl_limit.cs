...
{
    public sealed class HL_LIMIT : NativeType
    {
        private HL_LIMIT()
        {
            Name = "HL_LIMIT";
        ...
        public static readonly HL_LIMIT Inst = new HL_LIMIT();
        public override IField Create(JToken token)
        {
            var res = new HL_LIMITField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class HL_LIMITField : PreDefinedField
    {
        public HL_LIMITField(JToken token)
        {
