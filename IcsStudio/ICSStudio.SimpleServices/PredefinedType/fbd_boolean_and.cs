...
{
    public sealed class FBD_BOOLEAN_AND : NativeType
    {
        private FBD_BOOLEAN_AND()
        {
            Name = "FBD_BOOLEAN_AND";
            {
        ...
        public static readonly FBD_BOOLEAN_AND Inst = new FBD_BOOLEAN_AND();
        public override IField Create(JToken token)
        {
            var res = new FBD_BOOLEAN_ANDField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class FBD_BOOLEAN_ANDField : PreDefinedField
    {
        public FBD_BOOLEAN_ANDField(JToken token)
        {
