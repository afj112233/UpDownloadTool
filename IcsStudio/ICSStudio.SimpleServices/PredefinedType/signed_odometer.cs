...
{
    public sealed class SIGNED_ODOMETER : NativeType
    {
        private SIGNED_ODOMETER()
        {
            Name = "SIGNED_ODOMETER";
            {
        ...
        public static readonly SIGNED_ODOMETER Inst = new SIGNED_ODOMETER();
        public override IField Create(JToken token)
        {
            var res = new SIGNED_ODOMETERField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class SIGNED_ODOMETERField : PreDefinedField
    {
        public SIGNED_ODOMETERField(JToken token)
        {
