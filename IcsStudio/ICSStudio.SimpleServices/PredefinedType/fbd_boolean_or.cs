...
{
    public sealed class FBD_BOOLEAN_OR : NativeType
    {
        private FBD_BOOLEAN_OR()
        {
            Name = "FBD_BOOLEAN_OR";
            {
        ...
        public static readonly FBD_BOOLEAN_OR Inst = new FBD_BOOLEAN_OR();
        public override IField Create(JToken token)
        {
            var res = new FBD_BOOLEAN_ORField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class FBD_BOOLEAN_ORField : PreDefinedField
    {
        public FBD_BOOLEAN_ORField(JToken token)
        {
