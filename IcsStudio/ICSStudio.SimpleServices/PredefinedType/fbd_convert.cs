...
{
    public sealed class FBD_CONVERT : NativeType
    {
        private FBD_CONVERT()
        {
            Name = "FBD_CONVERT";
        ...
        public static readonly FBD_CONVERT Inst = new FBD_CONVERT();
        public override IField Create(JToken token)
        {
            var res = new FBD_CONVERTField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class FBD_CONVERTField : PreDefinedField
    {
        public FBD_CONVERTField(JToken token)
        {
