...
{
    public sealed class FBD_BOOLEAN_NOT : NativeType
    {
        private FBD_BOOLEAN_NOT()
        {
            Name = "FBD_BOOLEAN_NOT";
            {
        ...
        public static readonly FBD_BOOLEAN_NOT Inst = new FBD_BOOLEAN_NOT();
        public override IField Create(JToken token)
        {
            var res = new FBD_BOOLEAN_NOTField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class FBD_BOOLEAN_NOTField : PreDefinedField
    {
        public FBD_BOOLEAN_NOTField(JToken token)
        {
