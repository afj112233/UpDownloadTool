...
{
    public sealed class MOVING_STD_DEV : NativeType
    {
        private MOVING_STD_DEV()
        {
            Name = "MOVING_STD_DEV";
            {
        ...
        public static readonly MOVING_STD_DEV Inst = new MOVING_STD_DEV();
        public override IField Create(JToken token)
        {
            var res = new MOVING_STD_DEVField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class MOVING_STD_DEVField : PreDefinedField
    {
        public MOVING_STD_DEVField(JToken token)
        {
            ...
            fields.Add(Tuple.Create(new RealField(array?[8]) as IField, 24));
            fields.Add(Tuple.Create(new Int32Field(array?[9]) as IField, 28));
            fields.Add(Tuple.Create(new Int8Field(array?[10]) as IField, 32));
            fields.Add(Tuple.Create(new Int32Field(array?[11]) as IField, 36));
            fields.Add(Tuple.Create(new Int32Field(array?[12]) as IField, 40));
            fields.Add(Tuple.Create(new Int32Field(array?[13]) as IField, 44));
        }
    }
}