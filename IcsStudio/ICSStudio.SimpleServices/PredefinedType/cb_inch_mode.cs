...
{
    public sealed class CB_INCH_MODE : NativeType
    {
        private CB_INCH_MODE()
        {
            Name = "CB_INCH_MODE";
            {
        ...
        public static readonly CB_INCH_MODE Inst = new CB_INCH_MODE();
        public override IField Create(JToken token)
        {
            var res = new CB_INCH_MODEField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class CB_INCH_MODEField : PreDefinedField
    {
        public CB_INCH_MODEField(JToken token)
        {
