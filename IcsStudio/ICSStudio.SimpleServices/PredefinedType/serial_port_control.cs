...
{
    public sealed class SERIAL_PORT_CONTROL : NativeType
    {
        private SERIAL_PORT_CONTROL()
        {
        ...
        public static readonly SERIAL_PORT_CONTROL Inst = new SERIAL_PORT_CONTROL();
        public override IField Create(JToken token)
        {
            var res = new SERIAL_PORT_CONTROLField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class SERIAL_PORT_CONTROLField : PreDefinedField
    {
        public SERIAL_PORT_CONTROLField(JToken token)
        {
            ...
            fields.Add(Tuple.Create(new Int8Field(array?[5]) as IField, 14));
            fields.Add(Tuple.Create(new Int8Field(array?[6]) as IField, 15));
            fields.Add(Tuple.Create(new Int8Field(array?[7]) as IField, 16));
            fields.Add(Tuple.Create(new Int8Field(array?[8]) as IField, 17));
            fields.Add(Tuple.Create(new Int8Field(array?[9]) as IField, 18));
            fields.Add(Tuple.Create(new Int8Field(array?[10]) as IField, 19));
        }
    }
}