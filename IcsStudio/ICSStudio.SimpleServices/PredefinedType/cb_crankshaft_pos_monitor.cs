...
{
    public sealed class CB_CRANKSHAFT_POS_MONITOR : NativeType
    {
        private CB_CRANKSHAFT_POS_MONITOR()
        {
            Name = "CB_CRANKSHAFT_POS_MONITOR";
            {
        ...
        public static readonly CB_CRANKSHAFT_POS_MONITOR Inst = new CB_CRANKSHAFT_POS_MONITOR();
        public override IField Create(JToken token)
        {
            var res = new CB_CRANKSHAFT_POS_MONITORField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class CB_CRANKSHAFT_POS_MONITORField : PreDefinedField
    {
        public CB_CRANKSHAFT_POS_MONITORField(JToken token)
        {
            ...
            fields.Add(Tuple.Create(new Int32Field(array?[15]) as IField, 16));
            fields.Add(Tuple.Create(new Int32Field(array?[16]) as IField, 20));
