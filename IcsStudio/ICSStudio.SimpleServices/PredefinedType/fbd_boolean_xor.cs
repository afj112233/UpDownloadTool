...
{
    public sealed class FBD_BOOLEAN_XOR : NativeType
    {
        private FBD_BOOLEAN_XOR()
        {
            Name = "FBD_BOOLEAN_XOR";
            {
        ...
        public static readonly FBD_BOOLEAN_XOR Inst = new FBD_BOOLEAN_XOR();
        public override IField Create(JToken token)
        {
            var res = new FBD_BOOLEAN_XORField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class FBD_BOOLEAN_XORField : PreDefinedField
    {
        public FBD_BOOLEAN_XORField(JToken token)
        {
