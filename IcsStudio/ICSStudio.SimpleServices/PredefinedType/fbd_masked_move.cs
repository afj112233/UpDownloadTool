...
{
    public sealed class FBD_MASKED_MOVE : NativeType
    {
        private FBD_MASKED_MOVE()
        {
            Name = "FBD_MASKED_MOVE";
            {
        ...
        public static readonly FBD_MASKED_MOVE Inst = new FBD_MASKED_MOVE();
        public override IField Create(JToken token)
        {
            var res = new FBD_MASKED_MOVEField(token);
            FixUp(token, res);
            return res;
        }
    ...
    public sealed class FBD_MASKED_MOVEField : PreDefinedField
    {
        public FBD_MASKED_MOVEField(JToken token)
        {
