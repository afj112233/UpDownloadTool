...
namespace ICSStudio.EditorPackage.MonitorEditTags.Models
{
    ...
    public abstract class TagItem : INotifyPropertyChanged
    {
        ...
        //public virtual ExternalAccess ExternalAccess
        //{
        ...
        protected abstract List<TagItem> CreateChildren();
        ...
        protected virtual void OnTagPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            if (sender == Tag)
            {
                ...
                if (e.PropertyName.Equals("DataType.Name"))
                {
                    DataType = DataTypeInfo.ToString();
                    OnPropertyChanged("DataType.Name");
                }
            }
        }
        ...
        public virtual void OnPropertyChanged([CallerMemberName] string propertyName = null)
        {
            ...
            //    Change = false;
            //    CanChange = false;
            //    DisplayStyle = DisplayStyle == DisplayStyle.NullStyle ? DisplayStyle.Decimal : DisplayStyle;
            //    ExternalAccess = ExternalAccess == ExternalAccess.NullExternalAccess
            //        ? ExternalAccess.ReadWrite
            //        : ExternalAccess;
            //    DataType = string.IsNullOrEmpty(DataType) ? "DINT" : DataType;
            //    Usage = Usage == Usage.Empty ? Usage.Local : Usage;
            //}
        }
    }
