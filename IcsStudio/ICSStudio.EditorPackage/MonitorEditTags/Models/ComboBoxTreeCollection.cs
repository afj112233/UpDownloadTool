...
namespace ICSStudio.EditorPackage.MonitorEditTags.Models
{
    public class ComboBoxTreeCollection : ObservableCollection<ComboBoxTreeItem>
    {
            ...
            , ITagCollectionContainer tagCollectionContainer)
        {
            ...
            var equipmentPhasesItem = new ComboBoxTreeItem("Equipment Phases") {ParentCollection = this,IsEnable = false};
            var equipmentSequencesItem = new ComboBoxTreeItem("Equipment Sequences") {ParentCollection = this,IsEnable = false};
