...
namespace ICSStudio.FileConverter.L5XToJson.Objects
{
    ...
    {
        public static readonly string[] StringParameters = {"MotionGroup", "PositionUnits",};
        ...
        public static readonly string[] IntParameters =
        {
        ...
        public static JObject ToJObject(XmlElement parameters)
        {
            ...
            {
                axisVirtualParameters.Add(attributeName,
        ...
        private static int EnumParser(string name, string value)
        {
            switch (name)
            {
                ...
                case "RotaryAxis":
                    return (int) EnumUtils.Parse<SimpleServices.DataWrapper.AxisVirtualParameters.PositioningMode>(
                        value);
